...
function updateTime() {
    ...
    const dateString = now.toLocaleDateString("en-US", dateOptions), // [ toLocaleDateString() ] Obtenha uma data como uma string, usando convenções de localidade
        timeString = now.toLocaleTimeString("en-US", timeOptions); // [ toLocaleTimeString() ] Obtenha a parte da hora de uma data como uma string, usando convenções de localidade
